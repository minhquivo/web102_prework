...
Currently, ${unfundedCount} game${unfundedCount !== 1? "s":""} remain unfunded. We need your help to fund these amazing games!`

// create a new DOM element containing the template string and append it to the description container
const newElement = document.createElement("p");
newElement.innerHTML=`${unfundedString}`
...
topPledgeGame.innerText = firstGame.name;
